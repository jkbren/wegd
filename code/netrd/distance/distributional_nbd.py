...
class DistributionalNBD(BaseDistance):
    ...
    Computes the distance between two graphs using the empirical spectral
    density of the non-backtracking operator.
...
def nb_eigenvalues(B, k=None, **kwargs):
    ...
    if isinstance(B, np.ndarray):
        ...
        return sp.linalg.eigs(B, k=k, v0=random_state.random(B.shape[0]),
